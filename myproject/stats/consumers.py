...
class DashboardConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        """
        This method is called when the websocket is handshaking with the client
        """
        print('connected')
    ...
    async def receive(self, text_data):
        """
        This method is called when the server receives data
        from the client over the websocket
        """
